  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar: MotionTabBar(
        ...
        labels: const ["Profile", "Find","Home", "Chats", "Places","Tournaments"],
        icons: [FontAwesomeIcons.userTie, FontAwesomeIcons.addressBook, FontAwesomeIcons.usersViewfinder, Icons.chat_sharp, FontAwesomeIcons.chessRook, FontAwesomeIcons.trophy],
        tabSize: 45,
        tabBarHeight: 50,
