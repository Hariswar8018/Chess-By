          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Global.text11("  ${AppLocalizations.of(context)!.translate("ChessByPoints")}", w),
              ],
            ),  SizedBox(height: 20,),
            Center(
              child: Container(
                    ...
                    Column(
                      ...
                      children: [
                        CircleAvatar(
                          ...
                          child: Icon(Icons.subscriptions,color: Colors.white,size: 35,),
                        ),
                        SizedBox(height: 4,),
                        ...
                        Text("${AppLocalizations.of(context)!.translate("Total Points Earned")}",style: TextStyle(color: Colors.white),),
                      ],
                    ),
                    Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      ...
                      children: [
                        CircleAvatar(
                          ...
                          child: Icon(CupertinoIcons.bitcoin,color: Colors.white,size: 40,),
                        ),
                        SizedBox(height: 4,),
                        Text("${AppLocalizations.of(context)!.translate("No Subscription")}",style: TextStyle(color: Colors.yellow),),
                        SizedBox(height: 4,),
                        Global.text1("0", w),
                        Text("${AppLocalizations.of(context)!.translate("Total GamiCoins")}",style: TextStyle(color: Colors.white),),
                      ],
                    ),
                  ],
                ),
