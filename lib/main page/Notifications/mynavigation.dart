  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.black,
        title: Text("${AppLocalizations.of(context)!.translate("Notifications")}",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w800),),
      ),
      body: Column(
        children: [
          Padding(
...
class Chatr extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Center(
        child: Padding(
          padding: const EdgeInsets.all(8.0),
          child: user.accept?Center(
            child: Container(
              height: 90, width: MediaQuery.of(context).size.width-25,
              decoration: BoxDecoration(
                color: Global.blac,
  ...
  Widget fty(BuildContext context,double w){
    if(user.accept){
      return Row(
        mainAxisAlignment: MainAxisAlignment.spaceAround,
        children: [
          Text("${AppLocalizations.of(context)!.translate("You Accepted the Match")}"),
        ],
      );
    }else if(user.reject){
      return Row(
        ...
        children: [
          SizedBox(width: 10,),
          Icon(Icons.thumb_down_alt_rounded,color: Colors.red,),
          Text("  ${AppLocalizations.of(context)!.translate("You Rejected the Match")}",style: TextStyle(color: Colors.white),)
        ],
      );
    }else{
      return Row(
          ...
          InkWell(
              onTap: () async {
                try{
                  ...
                  Send.message(context, "${AppLocalizations.of(context)!.translate("Match Accepted Successfuly")}", true);
                  Send.sendNotificationsToTokens("${AppLocalizations.of(context)!.translate("Match Accepted Successfuly")}", "${user.sendername} Just Accepted your Match Invitations", user.mytoken);
                }catch(e){
                  Send.message(context, "$e", false);
                }
              },
              child: f(w,true,true,context)),
          InkWell(
              onTap: () async {
                try{
                  await FirebaseFirestore.instance.collection("Notification").doc(user.id).update({
                  ...
                  Send.message(context, "${AppLocalizations.of(context)!.translate("Match Rejected Successfuly")}", true);
                  Send.sendNotificationsToTokens("${AppLocalizations.of(context)!.translate("Match Rejected")} ","OOPs ! ${user.sendername} rejected your Match Invitations. It may be due to Personal Reasons. Try again next Time", user.mytoken);
                }catch(e){
                  Send.message(context, "$e", false);
                }
              },
              child: f(w,true,false,context)),
        ],
      );
    }
  }
  ...
  Widget f(double w, bool k,bool yes,BuildContext context)=>Container(
    width: w/2-35,
    height: 40,
    decoration: BoxDecoration(
      borderRadius: BorderRadius.circular(8),
    ...
    child:  Center(
      child: Text(yes?"${AppLocalizations.of(context)!.translate("Accept")}":"${AppLocalizations.of(context)!.translate("Reject")}",
              style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w600,
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height : 15),
            Text(" ${AppLocalizations.of(context)!.translate("Match Details")}",
                style: TextStyle(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text("   ${user.myname}, ${AppLocalizations.of(context)!.translate("sheduled a Match")}",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w400,fontSize: 16),)
                ],
              ),
            ),
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text("   ${user.sendername}, ${AppLocalizations.of(context)!.translate("waiting for Response")}",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w400,fontSize: 16),)
                ],
              ),
            ),
            SizedBox(height: 20,),
            ...
            SizedBox(height: 28,),
            Text("   ${AppLocalizations.of(context)!.translate("Game Preferences")}",
                style: TextStyle(
                    fontWeight: FontWeight.w500, color: Colors.grey, fontSize: 16)),
            SizedBox(height: 4,),
        ...
        Container(
            ...
            child: Container(
                ...
                child: MaterialButton(
                      ...
                      if(user.senderid==FirebaseAuth.instance.currentUser!.uid){
                        try {
                          ...
                          if (querySnapshot.docs.isNotEmpty) {
                            ...
                            Send.message(context, "${AppLocalizations.of(context)!.translate("No User Found ! Please contact UserId")}",false);
                            return null;
                          }
                        } catch (e) {
                          Send.message(context, "$e",false);
                    ...
                    child: Text("${AppLocalizations.of(context)!.translate("Check In")}",
                        style: TextStyle(
                            fontSize: 15,
                            fontWeight: FontWeight.w600,
                            color: Colors.black))))),
