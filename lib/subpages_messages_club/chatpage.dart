            ...
            children: [
                          ...
                          return Center(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text("${AppLocalizations.of(context)!.translate("Say Hi to each other")} 👋",
              ...
              Visibility(
                ...
                child: Align(
                  ...
                  child: Text("${AppLocalizations.of(context)!.translate("Nothing else")}",
                ),
              ),)
            ],
          ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "${AppLocalizations.of(context)!.translate("Last Online")} : " + formatDateTime(widget.user.lastloginn),
              ...
              child: Column(
                children: [
                  ...
                  InkWell(
                      ...
                      child: list(Icon(Icons.flight_takeoff_outlined,color: Colors.white,), "${AppLocalizations.of(context)!.translate("Challenge Player")}")),
                  InkWell(
                      onTap: (){
                        Navigator.push(
                      ...
                      child: list(Icon(Icons.map,color: Colors.white,), "${AppLocalizations.of(context)!.translate("Locate Player")}")),
                  ...
                  InkWell(
                      ...
                      child: list(Icon(Icons.block_outlined,color: Colors.white), "${AppLocalizations.of(context)!.translate("Block User")}")),
                  InkWell(
                      onTap: () async {
                        try{
                      ...
                      child: list(Icon(Icons.report_problem,color: Colors.white), "${AppLocalizations.of(context)!.translate("Report User")}")),
                  SizedBox(height: 10),
                ],
              ),
            ),
