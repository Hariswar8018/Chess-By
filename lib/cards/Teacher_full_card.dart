            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          title: Text(
                            " ${AppLocalizations.of(context)!.translate("Super Tutor" )}",
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.w600,
                                color: Colors.black),
                          ...
                          subtitle: Text(
                            " ${AppLocalizations.of(context)!.translate("A highly rated and experienced tutor" )}",
                            style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.w400,
                                color: Colors.black),
                        ...
                        child: Container(
                            ...
                            child: TextButton.icon(
                                ...
                                icon: Icon(CupertinoIcons.chat_bubble_2_fill,
                                    color: Colors.black),
                                label: Text("${AppLocalizations.of(context)!.translate("Message Me")}",
                                    style: TextStyle(
                                        fontSize: 16,
                                        fontWeight: FontWeight.w600,
                                        color: Colors.black))))),
                            ...
                            child: Container(
                                ...
                                child: TextButton.icon(
                                    ...
                                    icon: Icon(CupertinoIcons.mail,
                                        color: Colors.red),
                                    label: Text("${AppLocalizations.of(context)!.translate("Mail")}",
                                        style: TextStyle(
                                            fontSize: 16,
                                            fontWeight: FontWeight.w600,
                                            color: Colors.black))))),
                            ...
                            child: Container(
                                ...
                                child: TextButton.icon(
                                    ...
                                    icon: Icon(CupertinoIcons.star_lefthalf_fill,
                                        color: Colors.yellow),
                                    label: Text("${AppLocalizations.of(context)!.translate("Reviews")}",
                                        style: TextStyle(
                                            fontSize: 16,
                                            fontWeight: FontWeight.w600,
                                            color: Colors.black))))),
                  ...
                  Text(
                    "   ${AppLocalizations.of(context)!.translate("About the Tutor")}",
                    style: TextStyle(
                      fontSize: 19,
                      fontWeight: FontWeight.w600,
                      color: Colors.black,
                  ...
                  Text(
                    "  ${AppLocalizations.of(context)!.translate(" Specialities of the Tutor")}",
                    style: TextStyle(
                      fontSize: 19,
                      fontWeight: FontWeight.w600,
                      color: Colors.black,
        ...
        Container(
            ...
            child: Container(
                ...
                child: MaterialButton(
                    ...
                    child: Text("${AppLocalizations.of(context)!.translate("Book Lesson")}",
                        style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.w600,
                            color: Colors.black))))),
