...
class Hoyee extends StatefulWidget {
  ...
  @override
  State<Hoyee> createState() => _HoyeeState();
}

class _HoyeeState extends State<Hoyee> {
  String s = " ";
  initState(){
    super.initState();
    vq();
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: Text(widget.user.Name,maxLines:2,style: TextStyle(fontWeight: FontWeight.w900,color: Colors.white,fontSize: 18,letterSpacing: 0.2,height: 1.2),)),
                      SizedBox(height:2,),
