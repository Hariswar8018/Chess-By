                ...
                child: Row(
                  children: [
                    Column(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(left: 18.0,right: 8,bottom: 5),
                          child: Container(
                            width: w-105,
                    ...
                    InkWell(
                      onTap: () async {
                        ...
                        if (widget.user.Clublist.contains(g)) {
                          ...
                          Navigator.pop(context);
                          Send.message(context, "${AppLocalizations.of(context)!.translate("Wait , Adding you to Group")}", false);
                        }
                      },
                      child: CircleAvatar(
                        radius: 26,
                    ...
                    child: Container(
                        ...
                        child: TextButton.icon(
                            ...
                            icon: Icon(FontAwesomeIcons.mapLocation,
                                color: Colors.white),
                            label: Text("${AppLocalizations.of(context)!.translate("Locate Place")}",
                                style: TextStyle(
                                    fontSize: 16,
      ...
      return Column(
        children: [
          Padding(
            ...
            child: Row(
              children: [
                Text("${AppLocalizations.of(context)!.translate("Reviews")}",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w800,fontSize: 20),),
                Spacer(),
                InkWell(
                    onTap: (){
                      Navigator.push(
                    ...
                    child: Text("${AppLocalizations.of(context)!.translate("Write a Review")}",style: TextStyle(color: Colors.orange),)),
              ],
            ),
          ),
          Container(
                  ...
                  InkWell(
                      onTap: () async {
                        try{
                          ...
                          Navigator.pop(context);
                          Send.message(context, "${AppLocalizations.of(context)!.translate("Reported Successfully")}", true);
                        }catch(e){
                          Navigator.pop(context);
  ...
  Widget f(double w, bool k,bool yes)=>InkWell(
    ...
    child: Container(
      ...
      child: TextButton.icon(
          ...
          icon:yes? Icon(FontAwesomeIcons.mapLocation,
              color: Colors.black):Icon(CupertinoIcons.star,
              color: Colors.black),
          label: Text(yes?"${AppLocalizations.of(context)!.translate("Overview")}":"${AppLocalizations.of(context)!.translate("Reviews")}",
              style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w600,
                  color: Colors.black))),
