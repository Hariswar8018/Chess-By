import 'package:chessby/cards/Teacher_full_card.dart';
import 'package:chessby/cards/club_full_card.dart';
import 'package:chessby/models/club_model.dart';
import 'package:chessby/more_settings/support1.dart';
...
class Club_Navigation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("${AppLocalizations.of(context)!.translate("Your Club Profile")}"),
      ),
      body: Column(
        children: [
          ListTile(
            leading: Icon(Icons.remove_red_eye, color: Colors.purpleAccent, size: 30),
            title: Text("${AppLocalizations.of(context)!.translate("See Profile")}"),
            onTap: () async {
            ...
            subtitle: Text("${AppLocalizations.of(context)!.translate("See your Club Profile")}"), trailing: Icon(Icons.arrow_forward_ios_sharp, color: Colors.purpleAccent, size: 20,),
          ...
          ListTile(
            ...
            subtitle: Text("${AppLocalizations.of(context)!.translate("Edit Club Profile")}"),
          ...
          ListTile(
            ...
            subtitle: Text("${AppLocalizations.of(context)!.translate("Need help with anything? We are here")}"), trailing: Icon(Icons.arrow_forward_ios_sharp, color: Colors.greenAccent, size: 20,),
            splashColor: Colors.orange.shade300,
            tileColor: Colors.grey.shade50,
          ),
